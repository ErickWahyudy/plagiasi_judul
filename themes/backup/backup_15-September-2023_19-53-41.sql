#
# TABLE STRUCTURE FOR: tb_judul_skripsi
#

DROP TABLE IF EXISTS `tb_judul_skripsi`;

CREATE TABLE `tb_judul_skripsi` (
  `id_judul_skripsi` varchar(15) NOT NULL,
  `nama_mahasiswa` varchar(50) NOT NULL,
  `nim` varchar(12) NOT NULL,
  `nama_judul_skripsi` text NOT NULL,
...
INSERT INTO `tb_judul_skripsi` (`id_judul_skripsi`, `nama_mahasiswa`, `nim`, `nama_judul_skripsi`) VALUES ('J006UQr0E5', 'Ayu w', '19533099', 'ANALISIS PENGENDALIAN KUALITAS PRODUK DALAM UPAYA MENGENDALIKAN TINGKAT KERUSAKAN PRODUK MENGGUNAKAN STATISTICAL PROCESS CONTROL (SPC). (Studi kasus pada CV. Madiun Garment)');
INSERT INTO `tb_judul_skripsi` (`id_judul_skripsi`, `nama_mahasiswa`, `nim`, `nama_judul_skripsi`) VALUES ('J007rjLBak', 'Fannisa Tiara S', '19533174', 'PENERAPAN FUZZY K-NEAREST NEIGHBOR UNTUK DIAGNOSA PENYAKIT KULIT PADA KUCING');
INSERT INTO `tb_judul_skripsi` (`id_judul_skripsi`, `nama_mahasiswa`, `nim`, `nama_judul_skripsi`) VALUES ('J008ast0qB', 'Rika An Rokhim', '19533164', 'PENERAPAN METODE MOVING AVERAGE PADA SISTEM PREDIKSI PENJUALAN MENU MAKANAN (Studi Kasus: Rumah Makan Ayam Lodho Bu Sri)');
...
INSERT INTO `tb_judul_skripsi` (`id_judul_skripsi`, `nama_mahasiswa`, `nim`, `nama_judul_skripsi`) VALUES ('J016Un3L9w', 'Dewi', '17522611', ' PENERAPAN ALGORITMA BOYER MOORE PADA PENGARSIPAN DOKUMEN DI KUA KECAMATAN PUNUNG KABUPATEN PACITAN JAWA TIMUR');
INSERT INTO `tb_judul_skripsi` (`id_judul_skripsi`, `nama_mahasiswa`, `nim`, `nama_judul_skripsi`) VALUES ('J017NJ9Eyb', 'Kiki', '17535111', 'PENGARUH KUALITAS PRODUK, HARGA, DAN LOKASI TERHADAP KEPUTUSAN PEMBELIAN KONSUMEN DI TOKO AERO JALAN SUROMENGGOLO NO. 6 KELURAHAN BANGUNSARI KECAMATAN PONOROGO KABUPATEN PONOROGO');
INSERT INTO `tb_judul_skripsi` (`id_judul_skripsi`, `nama_mahasiswa`, `nim`, `nama_judul_skripsi`) VALUES ('J0180zOnEs', 'Rizki', '17654133', 'SISTEM PENDUKUNG KEPUTUSAN REKOMENDASI REKSA DANA OBLIGASI MENGGUNAKAN METODE SAW (SIMPLE ADDITIVE WEIGHTING)');
INSERT INTO `tb_judul_skripsi` (`id_judul_skripsi`, `nama_mahasiswa`, `nim`, `nama_judul_skripsi`) VALUES ('J019HlSZ5j', 'Liana', '19533199', 'MACHINE LEARNING PREDIKSI CUACA DENGAN DATA RECORD ALGORITMA K-NN DI WILAYAH DESA PLANCUNGAN');
INSERT INTO `tb_judul_skripsi` (`id_judul_skripsi`, `nama_mahasiswa`, `nim`, `nama_judul_skripsi`) VALUES ('J020X3e7cs', 'Tini', '19533144', 'Pengaruh Kualitas Jaringan Provider, Reputasi Perusahaan dan E-Service terhadap Perilaku Perpindahan Merek (Brand Switching) pada Kartu Perdana Telkomsel');
INSERT INTO `tb_judul_skripsi` (`id_judul_skripsi`, `nama_mahasiswa`, `nim`, `nama_judul_skripsi`) VALUES ('J02110TjKF', 'Yulia', '19533441', 'IMPLEMENTASI ALGORITMA FISHER-YATES SHUFFLE PADA PERMAINAN MATCHING CARD DALAM MEDIA PEMBELAJARAN BAHASA KOREA BERBASIS WEB.');
