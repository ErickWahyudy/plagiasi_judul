...
<div class="table-responsive">
    ...
    <script>
        ...
        $('#add').submit(function(e) {
            e.preventDefault();
            $.ajax({
                url: "<?= site_url('superadmin/judul_skripsi/api_add') ?>",
                type: "POST",
        ...
        $('#importExcelForm').submit(function(e) {
            ...
            $.ajax({
                url: "<?= site_url('superadmin/judul_skripsi/api_imporExcel') ?>",
                type: "POST",
                data: formData,
                processData: false,
                contentType: false,
    ...
    $(document).on('submit', '#edit', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('superadmin/judul_skripsi/api_edit/') ?>" + form_data.get('id_judul_skripsi'),
            dataType: "json",
            data: form_data,
            processData: false,
            contentType: false,
    ...
    function hapusjudulskripsi(id_judul_skripsi) {
        swal({
            ...
            if (result.value) { // Only delete the data if the user clicked on the confirm button
                $.ajax({
                    type: "POST",
                    url: "<?php echo site_url('superadmin/judul_skripsi/api_hapus/') ?>" + id_judul_skripsi,
                    dataType: "json",
                }).done(function() {
                    swal({
                        title: "Berhasil",
