<?php $this->load->view('template/header'); ?>
    ...
    <section class="content text-center">
          ...
          <form method="post" action="<?= site_url('superadmin/cek_plagiasi/calculate_similarity') ?>">
    ...
    <script>
        ...
        $('#add').submit(function(e) {
            e.preventDefault();
            $.ajax({
                url: "<?= site_url('superadmin/cek_plagiasi/api_check_plagiasi') ?>",
                type: "POST",
                ...
                success: function(data) {
                    if (data.status) {
                        ...
                        swal({
                            ...
                            window.location.href = "<?= site_url('superadmin/cek_plagiasi/lihat') ?>";
                        });
                    } else {
