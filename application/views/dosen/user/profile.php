...
<table class="table table-striped">
    <form action="" method="POST" enctype="multipart/form-data">
        ...
        <tr>
            <td></td>
            <td>
                <a href="../dosen/home" class="btn btn-primary">Kembali</a> &nbsp;&nbsp;
...
$(document).on('submit', '#edit', function(e) {
    ...
    $.ajax({
        type: "POST",
        url: "<?php echo site_url('dosen/profile/api_edit/') ?>" + form_data.get('id_pengguna'),
        dataType: "json",
        data: form_data,
        processData: false,
        contentType: false,
...
$(document).on('submit', '#gantipassword', function(e) {
    ...
    $.ajax({
        type: "POST",
        url: "<?php echo site_url('dosen/profile/api_password/') ?>" + form_data.get('id_pengguna'),
        dataType: "json",
        data: form_data,
        processData: false,
        contentType: false,
